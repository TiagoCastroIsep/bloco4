...
public class Bloco4Ex20 {
    ...
    public int[][] getProductOfAMatrixForOneConstant(int[][] matrix, int constant) {
    ...
    public int[][] getSumOfTwoMatrices(int[][] matrix1, int[][] matrix2) {
    ...
    public int[][] getProductOfTwoMatrices(int[][] matrix1, int[][] matrix2) {
        if (validateMatricesSizeNotEquals(matrix1, matrix2)) return null;
    ...
    private int getSumOfProductsOfMatrixLinesAndColumns(int[][] matrix1, int[][] matrix2, int i, int j) {
        int sum = 0;
        for (int k = 0; k < matrix1.length; k++) sum += matrix1[i][k] * matrix2[k][j];
        return sum;
    }

    private boolean validateMatricesSizeNotEquals(int[][] matrix1, int[][] matrix2) {
